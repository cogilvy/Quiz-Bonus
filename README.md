...
// Given the object above, write a function that will accept an object as an argument and return the name of the person whose eyes are yellow. Assume the object being passed as an argument will be the object above. 

function yellowEyeFinder() {

}

console.log(yellowEyeFinder(jediObj))
```
